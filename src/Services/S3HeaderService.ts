...
export class S3HeaderService extends Context.Tag("S3HeaderService")<
  S3HeaderService,
  {
    readonly toResponseHeaders: (
      result:
        | PutObjectResult
        | ObjectResponse
        | HeadObjectResult
...
export const S3HeaderServiceLive = Layer.succeed(
  S3HeaderService,
  S3HeaderService.of({
    toResponseHeaders: (result) => {
    ...
    toSwiftHeaders: (metadata, checksums) => {
